  ...
  var methods = {
    ...
    init : function(options) {
      ...
      return this.each(function() {
        ...
        var origHeaderRect, origHeaderWidth, origHeaderHeight;
        ...
        origin.off('click.galleryExpand').on('click.galleryExpand', function(e) {
          ...
          setOrigDimensions();
          if (origObjectWidth > windowWidth / 2 || fillScreen) {
            objectSizeAdjusted = true;
          } else {
          ...
          var recalculateVars = function() {
            ...
            navOffset = $('nav:not(.nav-extended)').first().height() || navOffset;
            ...
            newCardWidth = Math.min((windowWidth * 0.7), cardMaxWidth);
          ...
          $header.css({
            ...
            transform: 'translate3d(' + origHeaderRect.left + 'px,' + contentPadding + 'px,0)'
          });
        ...
        function returnToOriginal() {
          ...
          setTimeout(function() {
            ...
            if (!cancelledTimeout) {
              ...
              // Return header
              $header.css({
                transform: 'scaleX(1) translate3d(' + origHeaderRect.left + 'px,' + contentPadding + 'px,0)',
                transition: 'transform ' + (options.outDuration / 1000) + 's',
                '-webkit-transition': '-webkit-transform ' + (options.outDuration / 1000) + 's',
              });
            }
