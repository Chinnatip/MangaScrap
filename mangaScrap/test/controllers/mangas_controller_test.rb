...
class MangasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manga" do
    assert_difference('Manga.count') do
      post mangas_url, params: { manga: { author: @manga.author, chapter: @manga.chapter, name: @manga.name, rating: @manga.rating, source: @manga.source, viewer: @manga.viewer } }
    end
  ...
  test "should update manga" do
    patch manga_url(@manga), params: { manga: { author: @manga.author, chapter: @manga.chapter, name: @manga.name, rating: @manga.rating, source: @manga.source, viewer: @manga.viewer } }
