...
class UpdatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post updates_url, params: { update: { message: @update.message, phone: @update.phone } }
    end
  ...
  test "should update update" do
    patch update_url(@update), params: { update: { message: @update.message, phone: @update.phone } }
